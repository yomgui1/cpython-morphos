...
extern int PyByteArrayIter_Type;
extern int PyByteArray_Type;
extern int PyBytesIter_Type;
extern int PyBytes_Type;
extern int PyCFunction_Type;
extern int PyCallIter_Type;
extern int PyCapsule_Type;
extern int PyCell_Type;
extern int PyClassMethodDescr_Type;
extern int PyClassMethod_Type;
extern int PyCode_Type;
extern int PyComplex_Type;
extern int PyDictItems_Type;
extern int PyDictIterItem_Type;
extern int PyDictIterKey_Type;
extern int PyDictIterValue_Type;
extern int PyDictKeys_Type;
extern int PyDictProxy_Type;
extern int PyDictValues_Type;
extern int PyDict_Type;
extern int PyEllipsis_Type;
...
extern int PyExc_BlockingIOError;
extern int PyExc_BrokenPipeError;
extern int PyExc_BufferError;
extern int PyExc_BytesWarning;
extern int PyExc_ChildProcessError;
extern int PyExc_ConnectionAbortedError;
extern int PyExc_ConnectionError;
extern int PyExc_ConnectionRefusedError;
extern int PyExc_ConnectionResetError;
extern int PyExc_DeprecationWarning;
extern int PyExc_EOFError;
extern int PyExc_EnvironmentError;
extern int PyExc_Exception;
extern int PyExc_FileExistsError;
extern int PyExc_FileNotFoundError;
...
extern int PyExc_InterruptedError;
extern int PyExc_IsADirectoryError;
...
extern int PyExc_NotADirectoryError;
...
extern int PyExc_PermissionError;
extern int PyExc_ProcessLookupError;
extern int PyExc_RecursionErrorInst;
extern int PyExc_ReferenceError;
extern int PyExc_ResourceWarning;
...
extern int Py_hexdigits;
extern int _PyByteArray_empty_string;
extern int _PyLong_DigitValue;
extern int _PyManagedBuffer_Type;
extern int _PyMethodWrapper_Type;
extern int _PyNamespace_Type;
extern int _PyNone_Type;
extern int _PyNotImplemented_Type;
...
__attribute__((section (".text.pyapi"))) void PyMorphOS_InitGVars(struct PyMorphOS_GVar_STRUCT *storage)
{
    ...
    storage->p_PyByteArrayIter_Type                = &PyByteArrayIter_Type;
    storage->p_PyByteArray_Type                    = &PyByteArray_Type;
    storage->p_PyBytesIter_Type                    = &PyBytesIter_Type;
    storage->p_PyBytes_Type                        = &PyBytes_Type;
    storage->p_PyCFunction_Type                    = &PyCFunction_Type;
    storage->p_PyCallIter_Type                     = &PyCallIter_Type;
    storage->p_PyCapsule_Type                      = &PyCapsule_Type;
    storage->p_PyCell_Type                         = &PyCell_Type;
    storage->p_PyClassMethodDescr_Type             = &PyClassMethodDescr_Type;
    storage->p_PyClassMethod_Type                  = &PyClassMethod_Type;
    storage->p_PyCode_Type                         = &PyCode_Type;
    storage->p_PyComplex_Type                      = &PyComplex_Type;
    storage->p_PyDictItems_Type                    = &PyDictItems_Type;
    storage->p_PyDictIterItem_Type                 = &PyDictIterItem_Type;
    storage->p_PyDictIterKey_Type                  = &PyDictIterKey_Type;
    storage->p_PyDictIterValue_Type                = &PyDictIterValue_Type;
    storage->p_PyDictKeys_Type                     = &PyDictKeys_Type;
    storage->p_PyDictProxy_Type                    = &PyDictProxy_Type;
    storage->p_PyDictValues_Type                   = &PyDictValues_Type;
    storage->p_PyDict_Type                         = &PyDict_Type;
    storage->p_PyEllipsis_Type                     = &PyEllipsis_Type;
    ...
    storage->p_PyExc_BlockingIOError               = &PyExc_BlockingIOError;
    storage->p_PyExc_BrokenPipeError               = &PyExc_BrokenPipeError;
    storage->p_PyExc_BufferError                   = &PyExc_BufferError;
    storage->p_PyExc_BytesWarning                  = &PyExc_BytesWarning;
    storage->p_PyExc_ChildProcessError             = &PyExc_ChildProcessError;
    storage->p_PyExc_ConnectionAbortedError        = &PyExc_ConnectionAbortedError;
    storage->p_PyExc_ConnectionError               = &PyExc_ConnectionError;
    storage->p_PyExc_ConnectionRefusedError        = &PyExc_ConnectionRefusedError;
    storage->p_PyExc_ConnectionResetError          = &PyExc_ConnectionResetError;
    ...
    storage->p_PyExc_FileExistsError               = &PyExc_FileExistsError;
    storage->p_PyExc_FileNotFoundError             = &PyExc_FileNotFoundError;
    ...
    storage->p_PyExc_InterruptedError              = &PyExc_InterruptedError;
    storage->p_PyExc_IsADirectoryError             = &PyExc_IsADirectoryError;
    ...
    storage->p_PyExc_NotADirectoryError            = &PyExc_NotADirectoryError;
    ...
    storage->p_PyExc_PermissionError               = &PyExc_PermissionError;
    storage->p_PyExc_ProcessLookupError            = &PyExc_ProcessLookupError;
    storage->p_PyExc_RecursionErrorInst            = &PyExc_RecursionErrorInst;
    storage->p_PyExc_ReferenceError                = &PyExc_ReferenceError;
    storage->p_PyExc_ResourceWarning               = &PyExc_ResourceWarning;
    ...
    storage->p_PyExc_TimeoutError                  = &PyExc_TimeoutError;
    ...
    storage->p_PyFilter_Type                       = &PyFilter_Type;
    ...
    storage->p_PyGetSetDescr_Type                  = &PyGetSetDescr_Type;
    storage->p_PyImport_FrozenModules              = &PyImport_FrozenModules;
    storage->p_PyImport_Inittab                    = &PyImport_Inittab;
    storage->p_PyInstanceMethod_Type               = &PyInstanceMethod_Type;
    storage->p_PyListIter_Type                     = &PyListIter_Type;
    storage->p_PyListRevIter_Type                  = &PyListRevIter_Type;
    storage->p_PyList_Type                         = &PyList_Type;
    storage->p_PyLongRangeIter_Type                = &PyLongRangeIter_Type;
    storage->p_PyLong_Type                         = &PyLong_Type;
    storage->p_PyMap_Type                          = &PyMap_Type;
    storage->p_PyMemberDescr_Type                  = &PyMemberDescr_Type;
    storage->p_PyMemoryView_Type                   = &PyMemoryView_Type;
    storage->p_PyMethodDescr_Type                  = &PyMethodDescr_Type;
    ...
    storage->p_PyRangeIter_Type                    = &PyRangeIter_Type;
    ...
    storage->p_Py_IsolatedFlag                     = &Py_IsolatedFlag;
    storage->p_Py_NoSiteFlag                       = &Py_NoSiteFlag;
    storage->p_Py_NoUserSiteDirectory              = &Py_NoUserSiteDirectory;
    storage->p_Py_OptimizeFlag                     = &Py_OptimizeFlag;
    storage->p_Py_QuietFlag                        = &Py_QuietFlag;
    storage->p_Py_UnbufferedStdioFlag              = &Py_UnbufferedStdioFlag;
    storage->p_Py_UseClassExceptionsFlag           = &Py_UseClassExceptionsFlag;
    storage->p_Py_VerboseFlag                      = &Py_VerboseFlag;
    storage->p_Py_hexdigits                        = &Py_hexdigits;
    storage->p__PyByteArray_empty_string           = &_PyByteArray_empty_string;
    storage->p__PyLong_DigitValue                  = &_PyLong_DigitValue;
    storage->p__PyManagedBuffer_Type               = &_PyManagedBuffer_Type;
    storage->p__PyMethodWrapper_Type               = &_PyMethodWrapper_Type;
    storage->p__PyNamespace_Type                   = &_PyNamespace_Type;
    storage->p__PyNone_Type                        = &_PyNone_Type;
    storage->p__PyNotImplemented_Type              = &_PyNotImplemented_Type;
    ...
    storage->p__PySet_Dummy                        = &_PySet_Dummy;
