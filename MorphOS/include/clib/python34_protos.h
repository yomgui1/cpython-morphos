...
extern int PyErr_WarnFormat (void);
...
extern int PySys_FormatStderr (void);
extern int PySys_FormatStdout (void);
...
extern int _PyErr_TrySetFromCause (void);
...
extern int _PyObject_CallMethodId (void);
extern int _PyObject_CallMethodIdObjArgs (void);
extern int _PyObject_CallMethodId_SizeT (void);
