...
extern int PyUnicodeUCS4_Append (void);
extern int PyUnicodeUCS4_AppendAndDel (void);
extern int PyUnicodeUCS4_AsASCIIString (void);
extern int PyUnicodeUCS4_AsCharmapString (void);
extern int PyUnicodeUCS4_AsDecodedObject (void);
extern int PyUnicodeUCS4_AsDecodedUnicode (void);
extern int PyUnicodeUCS4_AsEncodedObject (void);
extern int PyUnicodeUCS4_AsEncodedString (void);
extern int PyUnicodeUCS4_AsEncodedUnicode (void);
...
extern int PyUnicodeUCS4_AsUTF32String (void);
...
extern int PyUnicodeUCS4_AsWideChar (void);
extern int PyUnicodeUCS4_AsWideCharString (void);
extern int PyUnicodeUCS4_Compare (void);
extern int PyUnicodeUCS4_CompareWithASCIIString (void);
...
extern int PyUnicodeUCS4_DecodeFSDefault (void);
extern int PyUnicodeUCS4_DecodeFSDefaultAndSize (void);
...
extern int PyUnicodeUCS4_DecodeUTF32 (void);
extern int PyUnicodeUCS4_DecodeUTF32Stateful (void);
...
extern int PyUnicodeUCS4_IsIdentifier (void);
...
extern int _PyBytes_FormatLong (void);
...
extern int _PyUnicode_AsString (void);
extern int _PyUnicode_AsStringAndSize (void);
...
extern int _PyUnicode_InsertThousandsGroupingLocale (void);
