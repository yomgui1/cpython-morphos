...
struct PyMorphOS_GVar_STRUCT {
    ...
    void* p_PyExc_BlockingIOError;
    void* p_PyExc_BrokenPipeError;
    void* p_PyExc_BufferError;
    void* p_PyExc_BytesWarning;
    void* p_PyExc_ChildProcessError;
    void* p_PyExc_ConnectionAbortedError;
    void* p_PyExc_ConnectionError;
    void* p_PyExc_ConnectionRefusedError;
    void* p_PyExc_ConnectionResetError;
    void* p_PyExc_DeprecationWarning;
    void* p_PyExc_EOFError;
    void* p_PyExc_EnvironmentError;
    void* p_PyExc_Exception;
    void* p_PyExc_FileExistsError;
    void* p_PyExc_FileNotFoundError;
    ...
    void* p_PyExc_InterruptedError;
    void* p_PyExc_IsADirectoryError;
    ...
    void* p__Py_FalseStruct;
    void* p__Py_Finalizing;
...
#define PyBytesIter_Type                    (*(PyTypeObject*)__pym_GVars.p_PyBytesIter_Type)
#define PyBytes_Type                        (*(PyTypeObject*)__pym_GVars.p_PyBytes_Type)
...
#define PyClassMethodDescr_Type             (*(PyTypeObject*)__pym_GVars.p_PyClassMethodDescr_Type)
...
#define PyExc_BlockingIOError               (*(PyObject **)__pym_GVars.p_PyExc_BlockingIOError)
#define PyExc_BrokenPipeError               (*(PyObject **)__pym_GVars.p_PyExc_BrokenPipeError)
...
#define PyExc_ChildProcessError             (*(PyObject **)__pym_GVars.p_PyExc_ChildProcessError)
#define PyExc_ConnectionAbortedError        (*(PyObject **)__pym_GVars.p_PyExc_ConnectionAbortedError)
#define PyExc_ConnectionError               (*(PyObject **)__pym_GVars.p_PyExc_ConnectionError)
#define PyExc_ConnectionRefusedError        (*(PyObject **)__pym_GVars.p_PyExc_ConnectionRefusedError)
#define PyExc_ConnectionResetError          (*(PyObject **)__pym_GVars.p_PyExc_ConnectionResetError)
...
#define PyExc_FileExistsError               (*(PyObject **)__pym_GVars.p_PyExc_FileExistsError)
#define PyExc_FileNotFoundError             (*(PyObject **)__pym_GVars.p_PyExc_FileNotFoundError)
...
#define PyExc_InterruptedError              (*(PyObject **)__pym_GVars.p_PyExc_InterruptedError)
#define PyExc_IsADirectoryError             (*(PyObject **)__pym_GVars.p_PyExc_IsADirectoryError)
...
#define PyExc_NotADirectoryError            (*(PyObject **)__pym_GVars.p_PyExc_NotADirectoryError)
...
#define PyExc_PermissionError               (*(PyObject **)__pym_GVars.p_PyExc_PermissionError)
#define PyExc_ProcessLookupError            (*(PyObject **)__pym_GVars.p_PyExc_ProcessLookupError)
...
#define PyExc_ResourceWarning               (*(PyObject **)__pym_GVars.p_PyExc_ResourceWarning)
...
#define PyExc_TimeoutError                  (*(PyObject **)__pym_GVars.p_PyExc_TimeoutError)
...
#define PyFilter_Type                       (*(PyTypeObject*)__pym_GVars.p_PyFilter_Type)
...
#define PyImport_FrozenModules              (*(const struct _frozen **)__pym_GVars.p_PyImport_FrozenModules)
#define PyImport_Inittab                    (*(struct _inittab **)__pym_GVars.p_PyImport_Inittab)
#define PyInstanceMethod_Type               (*(PyTypeObject*)__pym_GVars.p_PyInstanceMethod_Type)
#define PyListIter_Type                     (*(PyTypeObject*)__pym_GVars.p_PyListIter_Type)
#define PyListRevIter_Type                  (*(PyTypeObject*)__pym_GVars.p_PyListRevIter_Type)
#define PyList_Type                         (*(PyTypeObject*)__pym_GVars.p_PyList_Type)
#define PyLongRangeIter_Type                (*(PyTypeObject*)__pym_GVars.p_PyLongRangeIter_Type)
#define PyLong_Type                         (*(PyTypeObject*)__pym_GVars.p_PyLong_Type)
#define PyMap_Type                          (*(PyTypeObject*)__pym_GVars.p_PyMap_Type)
...
#define PyMethodDescr_Type                  (*(PyTypeObject*)__pym_GVars.p_PyMethodDescr_Type)
...
#define PyOS_ReadlineFunctionPointer        (*(char*(*)(FILE *, FILE *, const char *)*)__pym_GVars.p_PyOS_ReadlineFunctionPointer)
#define PyProperty_Type                     (*(PyTypeObject*)__pym_GVars.p_PyProperty_Type)
#define PyRangeIter_Type                    (*(PyTypeObject*)__pym_GVars.p_PyRangeIter_Type)
...
#define PySetIter_Type                      (*(PyTypeObject*)__pym_GVars.p_PySetIter_Type)
...
#define PyStdPrinter_Type                   (*(PyTypeObject*)__pym_GVars.p_PyStdPrinter_Type)
...
#define PyTupleIter_Type                    (*(PyTypeObject*)__pym_GVars.p_PyTupleIter_Type)
#define PyTuple_Type                        (*(PyTypeObject*)__pym_GVars.p_PyTuple_Type)
#define PyType_Type                         (*(PyTypeObject*)__pym_GVars.p_PyType_Type)
#define PyUnicodeIter_Type                  (*(PyTypeObject*)__pym_GVars.p_PyUnicodeIter_Type)
...
#define PyZip_Type                          (*(PyTypeObject*)__pym_GVars.p_PyZip_Type)
...
#define Py_HasFileSystemDefaultEncoding     (*(int*)__pym_GVars.p_Py_HasFileSystemDefaultEncoding)
...
#define Py_IsolatedFlag                     (*(int*)__pym_GVars.p_Py_IsolatedFlag)
...
#define Py_QuietFlag                        (*(int*)__pym_GVars.p_Py_QuietFlag)
#define Py_UnbufferedStdioFlag              (*(int*)__pym_GVars.p_Py_UnbufferedStdioFlag)
...
#define Py_hexdigits                        (*(const char **)__pym_GVars.p_Py_hexdigits)
#define _PyByteArray_empty_string           (*(char**)__pym_GVars.p__PyByteArray_empty_string)
#define _PyLong_DigitValue                  (*(unsigned char**)__pym_GVars.p__PyLong_DigitValue)
#define _PyManagedBuffer_Type               (*(PyTypeObject*)__pym_GVars.p__PyManagedBuffer_Type)
#define _PyMethodWrapper_Type               (*(PyTypeObject*)__pym_GVars.p__PyMethodWrapper_Type)
#define _PyNamespace_Type                   (*(PyTypeObject*)__pym_GVars.p__PyNamespace_Type)
#define _PyNone_Type                        (*(PyTypeObject*)__pym_GVars.p__PyNone_Type)
#define _PyNotImplemented_Type              (*(PyTypeObject*)__pym_GVars.p__PyNotImplemented_Type)
#define _PyOS_ReadlineTState                (*(PyThreadState**)__pym_GVars.p__PyOS_ReadlineTState)
#define _PyOS_optarg                        (*(wchar_t **)__pym_GVars.p__PyOS_optarg)
...
#define _PyParser_TokenNames                (*(const char ***)__pym_GVars.p__PyParser_TokenNames)
#define _PySet_Dummy                        (*(PyObject **)__pym_GVars.p__PySet_Dummy)
#define _PyThreadState_Current              (*(_Py_atomic_address*)__pym_GVars.p__PyThreadState_Current)
...
#define _Py_FalseStruct                     (*(struct _longobject*)__pym_GVars.p__Py_FalseStruct)
#define _Py_Finalizing                      (*(PyThreadState **)__pym_GVars.p__Py_Finalizing)
...
#define _Py_TrueStruct                      (*(struct _longobject*)__pym_GVars.p__Py_TrueStruct)
