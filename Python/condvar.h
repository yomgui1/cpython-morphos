...
#elif defined(MORPHOS_THREADS)

#define Py_HAVE_CONDVAR

#include <exec/semaphores.h>

typedef struct SignalSemaphore PyMUTEX_T;
...
#endif /* _POSIX_THREADS, NT_THREADS, MORPHOS_THREAD */
